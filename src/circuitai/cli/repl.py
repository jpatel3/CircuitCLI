...
SUBCOMMAND_META: dict[str, dict[str, str]] = {
    ...
    "browse": {
        "setup": "Configure site credentials",
        "sync": "Sync via browser automation",
        "status": "Show configured sites",
        "list-sites": "Available site adapters",
    },
    "subscriptions": {
        "list": "List all subscriptions",
        "detect": "Detect recurring charges",
        "add": "Add a subscription manually",
